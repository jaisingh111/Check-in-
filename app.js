    ...
    <div class="modal-backdrop" role="dialog" aria-modal="true">
      <div class="modal-card">
        <div class="modal-header">
          <div class="modal-title">Day ${dayId}</div>
          <button class="modal-x" type="button" aria-label="Close">×</button>
        </div>
        <div class="modal-body">
          <div class="modal-subtle">Choose what you want to do.</div>
          <div class="modal-actions">
            <button type="button" class="btn modal-btn" data-action="view" ${canView ? '' : 'disabled'}>
              View photo${(hasH && hasW) ? 's' : ''}
            </button>
            <button type="button" class="btn modal-btn" data-action="take">
              Take / replace (${selectedRole})
            </button>
            <button type="button" class="btn modal-btn secondary" data-action="cancel">
              Cancel
            </button>
          </div>
        </div>
...
function showPhotoViewer(dayId, data) {
  const root = ensureModalRoot();
  const hasH = !!data.husbandUrl;
  const hasW = !!data.wifeUrl;
  ...
  const hBlock = hasH ? `
    <div class="photo-block">
      <div class="photo-label">Husband</div>
      <img class="photo-img" src="${data.husbandUrl}" alt="Husband photo for ${dayId}" />
    </div>` : '';

  const wBlock = hasW ? `
    <div class="photo-block">
      <div class="photo-label">Wife</div>
      <img class="photo-img" src="${data.wifeUrl}" alt="Wife photo for ${dayId}" />
    </div>` : '';
  ...
  root.innerHTML = `
    <div class="modal-backdrop" role="dialog" aria-modal="true">
      <div class="modal-card modal-wide">
        <div class="modal-header">
          <div class="modal-title">Photos for ${dayId}</div>
          <button class="modal-x" type="button" aria-label="Close">×</button>
        </div>
        <div class="modal-body">
          <div class="photo-grid">
            ${hBlock || '<div class="photo-block empty"><div class="photo-label">Husband</div><div class="photo-missing">No photo</div></div>'}
            ${wBlock || '<div class="photo-block empty"><div class="photo-label">Wife</div><div class="photo-missing">No photo</div></div>'}
          </div>
          <div class="modal-actions">
            <button type="button" class="btn modal-btn" data-action="take">Take / replace (${selectedRole})</button>
            <button type="button" class="btn modal-btn secondary" data-action="close">Close</button>
          </div>
        </div>
      </div>
    </div>
